    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, height_field='height_field', null=True, upload_to=mcqexam.models.upload_location, width_field='width_field')),
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='mcqexam_user', to=settings.AUTH_USER_MODEL)),
            ],
            options={
